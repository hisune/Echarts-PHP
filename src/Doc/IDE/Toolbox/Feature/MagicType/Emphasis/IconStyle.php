 ...
 *    
 *     
 *     Fill color of text. If its not set, it will use in the order of icons fill color, stroke color, and #000.
 *
 ...
 *
 * @property int $textBorderRadius
 *    
 *     
 *     Border radius of text area.
 *
 * @property int $textPadding
 *    
 *     
