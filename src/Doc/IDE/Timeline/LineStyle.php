...
{            
    ...
    /**
     * @var boolean Whether to show the axis. It can be set to be false to hide the axis line to make a different style.
     */
    public $show = true;        
        
    /**
     * @var string timeline Line color. 
     * 
    ...
    /**
     * @var int timeline  line width.
     */
    public $width = 2;        
        
    /**
     * @var string timeline  line type.
     * Options are: 
     * 
     * solid
     * dashed
