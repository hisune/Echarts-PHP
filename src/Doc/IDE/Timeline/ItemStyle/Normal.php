...
namespace Hisune\EchartsPHP\Doc\IDE\Timeline\ItemStyle;

class Normal
{            
        
    /**
     * @var string timeline  color. 
     * 
    ...
    /**
     * @var string timeline  border color, whose format is similar to that of color.
     */
    public $borderColor = '"#000"';        
        
    /**
     * @var int timeline  border width. No border when it is set to be 0.
     */
