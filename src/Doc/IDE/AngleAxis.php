...
{            
    ...
    /**
     * @var int 角度轴所在的极坐标系的索引，默认使用第一个极坐标系。
     */
    public $polarIndex = 0;        
        
    /**
     * @var int 起始刻度的角度，默认为 90 度，即圆心的正上方。0 度为圆心的正右方。
     * 如下示例是 startAngle 为 45 的效果：
     */
    public $startAngle = 90;        
        
    /**
     * @var boolean 刻度增长是否按顺时针，默认顺时针。
    ...
    /**
     * @var AngleAxis\AxisLine 坐标轴轴线相关设置。
     */
    public $axisLine;        
        
    /**
     * @var AngleAxis\AxisTick 坐标轴刻度相关设置。
     */
    public $axisTick;        
        
    /**
     * @var AngleAxis\AxisLabel 坐标轴刻度标签的相关设置。
     */
    public $axisLabel;        
        
    /**
     * @var AngleAxis\SplitLine 坐标轴在 grid 区域中的分隔线。
     */
    public $splitLine;        
        
    /**
     * @var AngleAxis\SplitArea 坐标轴在 grid 区域中的分隔区域，默认不显示。
     */
    public $splitArea;        
    ...
    /**
     * @var AngleAxis\AxisPointer axisPointer settings on axis.
     */
    public $axisPointer;        
        
    /**
     * @var int 角度轴所有图形的 zlevel 值。
    ...
    /**
     * @var int 角度轴组件的所有图形的z值。控制图形的前后顺序。z值小的图形会被z值大的图形覆盖。
