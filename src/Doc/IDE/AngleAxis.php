...
{            
    ...
    /**
     * @var int The index of angle axis in Polar Coordinate. The first axis is used by default.
     */
    public $polarIndex = 0;        
        
    /**
     * @var int Starting angle of axis. 90 degrees by default, standing for top position of center. 0 degree stands for right position of center.
     * The following shows an example with startAngle of 45 deg.
     */
    public $startAngle = 90;        
        
    /**
     * @var boolean Whether the positive position of axis is in clockwise. True for clockwise by default.
    ...
    /**
     * @var AngleAxis\AxisLine Settings related to axis line.
     */
    public $axisLine;        
        
    /**
     * @var AngleAxis\AxisTick Settings related to axis tick.
     */
    public $axisTick;        
        
    /**
     * @var AngleAxis\AxisLabel Settings related to axis label.
     */
    public $axisLabel;        
        
    /**
     * @var AngleAxis\SplitLine SplitLine of axis in grid area.
     */
    public $splitLine;        
        
    /**
     * @var AngleAxis\SplitArea Split area of axis in grid area, not shown by default.
     */
    public $splitArea;        
    ...
    /**
     * @var AngleAxis\AxisPointer axisPointer settings on the axis.
     */
    public $axisPointer;        
        
    /**
     * @var int zlevel value of all graghical elements in Angle Axis.
    ...
    /**
     * @var int z value of all graghical elements in Angle Axis, which controls order of drawing graphical components. Components with smaller z values may be overwritten by those with larger z values.
