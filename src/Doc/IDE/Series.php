...
{            
    ...
    /**
     * @var string 系列名称，用于tooltip的显示，legend 的图例筛选，在 setOption 更新数据和配置项时用于指定对应的系列。
     */
    public $name;        
        
    /**
     * @var string 该系列使用的坐标系，可选：
     * 
     * cartesian2d
    ...
    /**
     * @var int 使用的 x 轴的 index，在单个图表实例中存在多个 x 轴的时候有用。
     */
    public $xAxisIndex = 0;        
        
    /**
     * @var int 使用的 y 轴的 index，在单个图表实例中存在多个 y轴的时候有用。
     */
    public $yAxisIndex = 0;        
        
    /**
     * @var int 使用的极坐标系的 index，在单个图表实例中存在多个极坐标系的时候有用。
     */
    public $polarIndex = 0;        
    ...
    /**
     * @var int|array|callable 标记的大小，可以设置成诸如 10 这样单一的数字，也可以用数组分开表示宽和高，例如 [20, 10] 表示标记宽为20，高为10。
    ...
    /**
     * @var int 标记的旋转角度。注意在 markLine 中当 symbol 为 arrow 时会忽略 symbolRotate 强制设置为切线的角度。
     */
    public $symbolRotate;        
        
    /**
     * @var array 标记相对于原本位置的偏移。默认情况下，标记会居中置放在数据对应的位置，但是如果 symbol 是自定义的矢量路径或者图片，就有可能不希望 symbol 居中。这时候可以使用该配置项配置 symbol 相对于原本居中的偏移，可以是绝对的像素值，也可以是相对的百分比。
     * 例如 [0, 50%] 就是把自己向上移动了一半的位置，在 symbol 图形是气泡的时候可以让图形下端的箭头对准数据点。
     */
    public $symbolOffset = '[0, 0]';        
        
    /**
     * @var boolean 是否显示 symbol, 如果 false 则只有在 tooltip hover 的时候显示。
     */
    public $showSymbol = true;        
        
    /**
     * @var boolean 标志图形默认只有主轴显示（随主轴标签间隔隐藏策略），如需全部显示可把 showAllSymbol 设为 true。
     */
    public $showAllSymbol = false;        
        
    /**
     * @var boolean 是否开启 hover 在拐点标志上的提示动画效果。
     */
    public $hoverAnimation = true;        
        
    /**
     * @var boolean 是否启用图例 hover 时的联动高亮。
     */
    public $legendHoverLink = true;        
        
    /**
     * @var string 数据堆叠，同个类目轴上系列配置相同的stack值后，后一个系列的值会在前一个系列的值上相加。
    ...
    /**
     * @var boolean 是否对超出部分裁剪，默认裁剪。
     */
    public $clipOverflow = true;        
        
    /**
     * @var string|boolean 是否是阶梯线图。可以设置为 true 显示成阶梯线图，也支持设置成 start, middle, end 分别配置在当前点，当前点与下个点的中间点，下个点拐弯。
     * 不同的配置效果如下：
     */
    public $step = false;        
        
    /**
     * @var Series\Label 图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等，label选项在 ECharts 2.x 中放置于itemStyle.normal下，在 ECharts 3 中为了让整个配置项结构更扁平合理，label 被拿出来跟 itemStyle 平级，并且跟 itemStyle 一样拥有 normal, emphasis 两个状态。
     */
    public $label;        
        
    /**
     * @var Series\ItemStyle 折线拐点标志的样式。
     */
    public $itemStyle;        
        
    /**
     * @var Series\LineStyle 线条样式。
     * 注： 修改 lineStyle 中的颜色不会影响图例颜色，如果需要图例颜色和折线图颜色一致，需修改 itemStyle.normal.color，线条颜色默认也会取改颜色。
     */
    public $lineStyle;        
        
    /**
     * @var Series\AreaStyle 区域填充样式。
     */
    public $areaStyle;        
    ...
    /**
     * @var string 折线平滑后是否在一个维度上保持单调性，可以设置成x, y来指明是在 x 轴或者 y 轴上保持单调性。
     * 通常在双数值轴上使用。
    ...
    /**
     * @var string 折线图在数据量远大于像素点时候的降采样策略，开启后可以有效的优化图表的绘制效率，默认关闭，也就是全部绘制不过滤数据点。
     * 可选：
     * 
     * average 取过滤点的平均值
     * max 取过滤点的最大值
    ...
    /**
     * @var Series\MarkPoint 图表标注。
     */
    public $markPoint;        
        
    /**
     * @var Series\MarkLine 图表标线。
     */
    public $markLine;        
        
    /**
     * @var Series\MarkArea 图表标域，常用于标记图表中某个范围的数据，例如标出某段时间投放了广告。
     */
    public $markArea;        
        
    /**
     * @var int 折线图所有图形的 zlevel 值。
    ...
    /**
     * @var int 折线图组件的所有图形的z值。控制图形的前后顺序。z值小的图形会被z值大的图形覆盖。
    ...
    /**
     * @var Series\Tooltip 本系列特定的 tooltip 设定。
     */
    public $tooltip;        
        
    /**
     * @var int|string 柱条的宽度，不设时自适应。支持设置成相对于类目宽度的百分比。
     * 在同一坐标系上，此属性会被多个 bar 系列共享。此属性应设置于此坐标系中最后一个 bar 系列上才会生效，并且是对此坐标系中所有 bar 系列生效。
     */
    public $barWidth = '自适应';        
        
    /**
     * @var int|string 柱条的最大宽度，不设时自适应。支持设置成相对于类目宽度的百分比。
     * 在同一坐标系上，此属性会被多个 bar 系列共享。此属性应设置于此坐标系中最后一个 bar 系列上才会生效，并且是对此坐标系中所有 bar 系列生效。
     */
    public $barMaxWidth = '自适应';        
        
    /**
     * @var int 柱条最小高度，可用于防止某数据项的值过小而影响交互。
     */
    public $barMinHeight = 0;        
        
    /**
     * @var string 柱间距离，可设固定值（如 20）或者百分比（如 30%，表示柱子宽度的 30%）。
    ...
    /**
     * @var string 类目间柱形距离，默认为类目间距的20%，可设固定值
     * 在同一坐标系上，此属性会被多个 bar 系列共享。此属性应设置于此坐标系中最后一个 bar 系列上才会生效，并且是对此坐标系中所有 bar 系列生效。
     */
    public $barCategoryGap = '20%';        
        
    /**
     * @var boolean|string 选中模式，表示是否支持多个选中，默认关闭，支持布尔值和字符串，字符串取值可选single，multiple，分别表示单选还是多选。
     */
    ...
    /**
     * @var boolean 饼图的扇区是否是顺时针排布。
     */
    public $clockwise = true;        
        
    /**
     * @var int 起始角度，支持范围[0, 360]。
     */
    public $startAngle = 90;        
        
    /**
     * @var int 最小的扇区角度（0 ~ 360），用于防止某个值过小导致扇区太小影响交互。
     */
    public $minAngle = 0;        
        
    /**
     * @var boolean|string 是否展示成南丁格尔图，通过半径区分数据大小。可选择两种模式：
     * 
    ...
    /**
     * @var boolean 是否启用防止标签重叠策略，默认开启，在标签拥挤重叠的情况下会挪动各个标签的位置，防止标签间的重叠。
     * 如果不需要开启该策略，例如圆环图这个例子中需要强制所有标签放在中心位置，可以将该值设为 false。
     */
    public $avoidLabelOverlap = true;        
        
    /**
     * @var boolean 是否在数据和为0（一般情况下所有数据为0） 的时候不显示扇区。
     */
    public $stillShowZeroSum = true;        
        
    /**
     * @var Series\LabelLine 标签的视觉引导线样式，在 label 位置 设置为outside的时候会显示视觉引导线。
     */
    public $labelLine;        
        
    /**
     * @var array 饼图的中心（圆心）坐标，数组的第一项是横坐标，第二项是纵坐标。
    ...
    /**
     * @var array 饼图的半径，数组的第一项是内半径，第二项是外半径。
    ...
    /**
     * @var int 使用的地理坐标系的 index，在单个图表实例中存在多个地理坐标系的时候有用。
     */
    public $geoIndex = 0;        
        
    /**
     * @var boolean 是否开启大规模散点图的优化，在数据图形特别多的时候（&gt;=5k）可以开启。
     ...
     * @var int 开启绘制优化的阈值。
     */
    public $largeThreshold = 2000;        
        
    /**
     * @var string 特效类型，目前只支持涟漪特效ripple。
     */
    ...
    /**
     * @var Series\RippleEffect 涟漪特效相关配置。
     */
    public $rippleEffect;        
        
    /**
     * @var int 雷达图所使用的 radar 组件的 index。
     */
    public $radarIndex;        
        
    /**
     * @var string|int treemap 组件离容器左侧的距离。
    ...
    /**
     * @var string|int treemap 组件离容器上侧的距离。
    ...
    /**
     * @var string|int treemap 组件离容器右侧的距离。
    ...
    /**
     * @var string|int treemap 组件离容器下侧的距离。
    ...
    /**
     * @var string|int treemap 组件的宽度。
     */
    public $width = '80%';        
        
    /**
     * @var string|int treemap 组件的高度。
     */
    public $height = '80%';        
        
    /**
     * @var int 期望矩形长宽比率。布局计算时会尽量向这个比率靠近。
     * 默认为黄金比：0.5 * (1 + Math.sqrt(5))。
     */
    public $squareRatio;        
        
    /**
     * @var int 设置了 leafDepth 后，下钻（drill down）功能开启。drill down 功能即点击后才展示子层级。
    ...
    /**
     * @var boolean|string 是否开启拖拽漫游（移动和缩放）。可取值有：
     * 
     * false：关闭。
     * scale 或 zoom：只能够缩放。
     * move 或 pan：只能够平移。
    ...
    /**
     * @var boolean|string 点击节点后的行为。可取值为：
     * 
     * false：节点点击无反应。
    ...
    /**
     * @var int 点击某个节点，会自动放大那个节点到合适的比例（节点占可视区域的面积比例），这个配置项就是这个比例。
     */
    ...
    /**
     * @var int treemap 中支持对数据其他维度进行视觉映射。
    ...
    /**
     * @var int 当前层级的最小 value 值。如果不设置则自动统计。
     * 手动指定 visualMin、visualMax ，即手动控制了 visual mapping 的值域（当 colorMappingBy 为 value 时有意义）。
     */
    public $visualMin;        
        
    /**
     * @var int 当前层级的最大 value 值。如果不设置则自动统计。
     * 手动指定 visualMin、visualMax ，即手动控制了 visual mapping 的值域（当 colorMappingBy 为 value 时有意义）。
     */
    public $visualMax;        
        
    /**
     * @var array 本系列默认的 颜色透明度 选取范围。数值范围 0 ~ 1。
    ...
    /**
     * @var int 本系列默认的 颜色饱和度 选取范围。数值范围 0 ~ 1。
    ...
    /**
     * @var string 表示同一层级节点，在颜色列表中（参见 color 属性）选择时，按照什么来选择。可选值：
     * 
     * value：
     * 
    ...
    /**
     * @var int 如果某个节点的矩形的面积，小于这个数值（单位：px平方），这个节点就不显示。
    ...
    /**
     * @var int 如果某个节点的矩形面积，小于这个数值（单位：px平方），则不显示这个节点的子节点。
    ...
    /**
     * @var Series\Breadcrumb 面包屑，能够显示当前节点的路径。
     */
    public $breadcrumb;        
    ...
    /**
     * @var array box 的宽度的上下限。数组的意思是：[min, max]。
     * 可以是绝对数值，如 [7, 50]，也可以是百分比，如 [40%, 90%]。百分比的意思是，最大可能宽度（bandWidth）的百分之多少。
     */
    public $boxWidth = '[7, 50]';        
        
    /**
     * @var int 指定柱最大宽度。可以使用绝对数值（如 10）或百分比（如 20%，表示 band width 的百分之多少）。默认自适应。
     */
    public $barMinWidth;        
        
    /**
     * @var int 每个点模糊的大小，在地理坐标系(coordinateSystem: geo)上有效。
     */
    public $blurSize = 20;        
        
    /**
     * @var int 最小的透明度，在地理坐标系(coordinateSystem: geo)上有效。
     */
    public $minOpacity = 0;        
        
    /**
     * @var int 最大的透明度，在地理坐标系(coordinateSystem: geo)上有效。
     */
    public $maxOpacity = 1;        
    ...
    /**
     * @var Series\ScaleLimit 滚轮缩放的极限控制，通过min, max最小和最大的缩放值，默认的缩放为1。
     */
    public $scaleLimit;        
        
    /**
     * @var array 自定义地区的名称映射，如：
     * {
     *     China : 中国
     * }
     */
    ...
    /**
     * @var array layoutCenter 和 layoutSize 提供了除了 left/right/top/bottom/width/height 之外的布局手段。
    ...
    /**
     * @var int|string 地图的大小，见 layoutCenter。支持相对于屏幕宽高的百分比或者绝对的像素大小。
     */
    public $layoutSize;        
        
    /**
     * @var string 多个拥有相同地图类型的系列会使用同一个地图展现，如果多个系列都在同一个区域有值，ECharts 会对这些值统计得到一个数据。这个配置项就是用于配置统计的方式，目前有：
     * 
     * sum   取和。
     * average 取平均值。
     * max   取最大值。
    ...
    /**
     * @var boolean 在图例相应区域显示图例的颜色标识（系列标识的小圆点），存在 legend 组件时生效。
     */
    public $showLegendSymbol;        
        
    /**
     * @var int 使用的平行坐标系的 index，在单个图表实例中存在多个平行坐标系的时候有用。
     */
    public $parallelIndex = 0;        
        
    /**
     * @var int 框选时，未被选中的条线会设置成这个『透明度』（从而可以达到变暗的效果）。
     */
    public $inactiveOpacity = 0.05;        
        
    /**
     * @var int 框选时，选中的条线会设置成这个『透明度』（从而可以达到高亮的效果）。
     */
    ...
    /**
     * @var Series\Effect 线特效的配置，见示例 模拟迁徙 和 北京公交路线
     * 注意： 所有带有尾迹特效的图表需要单独放在一个层，也就是需要单独设置 zlevel，同时建议关闭该层的动画（animation: false）。不然位于同个层的其它系列的图形，和动画的标签也会产生不必要的残影。
     */
    public $effect;        
        
    /**
     * @var Series\Circular 环形布局相关配置
     */
    public $circular;        
        
    /**
     * @var Series\Force 力引导布局相关的配置项，力引导布局是模拟弹簧电荷模型在每两个节点之间添加一个斥力，每条边的两个节点之间添加一个引力，每次迭代节点会在各个斥力和引力的作用下移动位置，多次迭代后节点会静止在一个受力平衡的位置，达到整个模型的能量最小化。
     * 力引导布局的结果有良好的对称性和局部聚合性，也比较美观。
     */
    public $force;        
        
    /**
     * @var int 鼠标漫游缩放时节点的相应缩放比例，当设为0时节点不随着鼠标的缩放而缩放
     */
    public $nodeScaleRatio = 0.6;        
        
    /**
     * @var boolean 节点是否可拖拽，只在使用力引导布局的时候有用。
     */
    public $draggable = false;        
        
    /**
     * @var boolean 是否在鼠标移到节点上的时候突出显示节点以及节点的边和邻接节点。
     */
    public $focusNodeAdjacency = false;        
        
    /**
     * @var array|string 边两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定。默认不显示标记，常见的可以设置为箭头，如下：
     * edgeSymbol: [circle, arrow]
     */
    public $edgeSymbol = '[\'none\', \'none\']';        
        
    /**
     * @var array|int 边两端的标记大小，可以是一个数组分别指定两端，也可以是单个统一指定。
     */
    public $edgeSymbolSize = 10;        
        
    /**
     * @var Series\EdgeLabel 
     */
    public $edgeLabel;        
        
    /**
     * @var array 节点分类的类目，可选。
    ...
    /**
     * @var int 图中每一列任意两个矩形节点之间的间隔。
     */
    public $nodeGap = 8;        
        
    /**
     * @var int 布局的迭代次数，用来不断优化图中节点的位置，以减少节点和边之间的相互遮盖。
     * 默认布局迭代次数：32。
     * 经测试，布局迭代次数不要低于默认值。
     */
    ...
    /**
     * @var string 数据最小值 min 映射的宽度。
     * 可以是绝对的像素大小，也可以是相对布局宽度的百分比，如果需要最小值的图形并不是尖端三角，可通过设置该属性实现。
     */
    public $minSize = '0%';        
        
    /**
     * @var string 数据最大值 max 映射的宽度。
     * 可以是绝对的像素大小，也可以是相对布局宽度的百分比。
     */
    public $maxSize = '100%';        
        
    /**
     * @var string 数据排序， 可以取 ascending, descending。
     */
    ...
    /**
     * @var string 水平方向对齐布局类型，默认居中对齐，可用选项还有：left | right | center
     */
    ...
    /**
     * @var Series\AxisLine 仪表盘轴线相关配置。
     */
    public $axisLine;        
        
    /**
     * @var Series\SplitLine 分隔线样式。
     */
    public $splitLine;        
        
    /**
     * @var Series\AxisTick 刻度样式。
     */
    public $axisTick;        
        
    /**
     * @var Series\AxisLabel 刻度标签。
     */
    public $axisLabel;        
        
    /**
     * @var Series\Pointer 仪表盘指针。
     */
    public $pointer;        
        
    /**
     * @var Series\Title 仪表盘标题。
     */
    public $title;        
        
    /**
     * @var Series\Detail 仪表盘详情，用于显示数据。
     */
    public $detail;        
        
    /**
     * @var string 图形的定位位置。可取值：
     * 
    ...
    /**
     * @var boolean|int|string 指定图形元素是否重复。值可为：
     * 
    ...
    /**
     * @var string 指定图形元素重复时，绘制的顺序。这个属性在两种情况下有用处：
     * 
    ...
    /**
     * @var int|string 图形的两边间隔（『两边』是指其数值轴方向的两边）。可以是绝对数值（如 20），或者百分比值（如 -30%），表示相对于自身尺寸 symbolSize 的百分比。只有当 symbolRepeat 被使用时有意义。
    ...
    /**
     * @var int 这个属性是『指定图形界限的值』。它指定了一个 data，这个 data 映射在坐标系上的位置，是图形绘制的界限。也就是说，如果设置了 symbolBoundingData，图形的尺寸则由 symbolBoundingData 决定。
    ...
    /**
     * @var array 图中与坐标轴正交的方向的边界间隙，设置该值是为了调整图的位置，使其尽量处于屏幕的正中间，避免处于屏幕的上方或下方。
     */
    public $boundaryGap = '["10%", "10%"]';        
        
    /**
     * @var int 单个时间轴的index，默认值为0，因为只有单个轴。
     */
