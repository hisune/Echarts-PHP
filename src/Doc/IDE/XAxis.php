...
{            
    ...
    /**
     * @var boolean 是否显示 x 轴。
     */
    public $show = true;        
        
    /**
     * @var int x 轴所在的 grid 的索引，默认位于第一个 grid。
     */
    public $gridIndex = 0;        
    ...
    /**
     * @var int X 轴相对于默认位置的偏移，在相同的 position 上有多个 X 轴的时候有用。
     */
    public $offset = 0;        
    ...
    /**
     * @var XAxis\NameTextStyle 坐标轴名称的文字样式。
     */
    ...
    /**
     * @var XAxis\AxisLine 坐标轴轴线相关设置。
     */
    public $axisLine;        
        
    /**
     * @var XAxis\AxisTick 坐标轴刻度相关设置。
     */
    public $axisTick;        
        
    /**
     * @var XAxis\AxisLabel 坐标轴刻度标签的相关设置。
     */
    public $axisLabel;        
        
    /**
     * @var XAxis\SplitLine 坐标轴在 grid 区域中的分隔线。
     */
    public $splitLine;        
        
    /**
     * @var XAxis\SplitArea 坐标轴在 grid 区域中的分隔区域，默认不显示。
     */
    public $splitArea;        
    ...
    /**
     * @var XAxis\AxisPointer axisPointer settings on axis.
     */
    public $axisPointer;        
        
    /**
     * @var int X 轴所有图形的 zlevel 值。
    ...
    /**
     * @var int X 轴组件的所有图形的z值。控制图形的前后顺序。z值小的图形会被z值大的图形覆盖。
