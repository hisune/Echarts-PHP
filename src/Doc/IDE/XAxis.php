...
{            
    ...
    /**
     * @var boolean If show x axis.
     */
    public $show = true;        
        
    /**
     * @var int The index of grid which the x axis belongs to. Defaults to be in the first grid.
     */
    public $gridIndex = 0;        
        
    /**
     * @var string The position of x axis.
     * options:
     * 
     * top
     * bottom
    ...
    /**
     * @var int Offset of x axis relative to default position. Useful when multiple x axis has same position value.
     */
    public $offset = 0;        
    ...
    /**
     * @var XAxis\NameTextStyle Text style of axis name.
     */
    ...
    /**
     * @var XAxis\AxisLine Settings related to axis line.
     */
    public $axisLine;        
        
    /**
     * @var XAxis\AxisTick Settings related to axis tick.
     */
    public $axisTick;        
        
    /**
     * @var XAxis\AxisLabel Settings related to axis label.
     */
    public $axisLabel;        
        
    /**
     * @var XAxis\SplitLine SplitLine of axis in grid area.
     */
    public $splitLine;        
        
    /**
     * @var XAxis\SplitArea Split area of axis in grid area, not shown by default.
     */
    public $splitArea;        
    ...
    /**
     * @var XAxis\AxisPointer axisPointer settings on the axis.
     */
    public $axisPointer;        
        
    /**
     * @var int zlevel value of all graghical elements in x axis.
    ...
    /**
     * @var int z value of all graghical elements in x axis, which controls order of drawing graphical components. Components with smaller z values may be overwritten by those with larger z values.
