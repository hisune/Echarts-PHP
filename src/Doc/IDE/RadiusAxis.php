...
{            
    ...
    /**
     * @var int Index of radial axis in polor coordinate. Its the first axis by default.
     */
    public $polarIndex = 0;        
    ...
    /**
     * @var RadiusAxis\NameTextStyle Text style of axis name.
     */
    ...
    /**
     * @var RadiusAxis\AxisLine Settings related to axis line.
     */
    public $axisLine;        
        
    /**
     * @var RadiusAxis\AxisTick Settings related to axis tick.
     */
    public $axisTick;        
        
    /**
     * @var RadiusAxis\AxisLabel Settings related to axis label.
     */
    public $axisLabel;        
        
    /**
     * @var RadiusAxis\SplitLine SplitLine of axis in grid area.
     */
    public $splitLine;        
        
    /**
     * @var RadiusAxis\SplitArea Split area of axis in grid area, not shown by default.
     */
    public $splitArea;        
    ...
    /**
     * @var RadiusAxis\AxisPointer axisPointer settings on the axis.
     */
    public $axisPointer;        
        
    /**
     * @var int zlevel value of all graghical elements in Radial axis.
    ...
    /**
     * @var int z value of all graghical elements in Radial axis, which controls order of drawing graphical components. Components with smaller z values may be overwritten by those with larger z values.
