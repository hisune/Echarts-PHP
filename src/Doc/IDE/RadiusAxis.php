...
{            
    ...
    /**
     * @var int 径向轴所在的极坐标系的索引，默认使用第一个极坐标系。
     */
    public $polarIndex = 0;        
    ...
    /**
     * @var RadiusAxis\NameTextStyle 坐标轴名称的文字样式。
     */
    ...
    /**
     * @var RadiusAxis\AxisLine 坐标轴轴线相关设置。
     */
    public $axisLine;        
        
    /**
     * @var RadiusAxis\AxisTick 坐标轴刻度相关设置。
     */
    public $axisTick;        
        
    /**
     * @var RadiusAxis\AxisLabel 坐标轴刻度标签的相关设置。
     */
    public $axisLabel;        
        
    /**
     * @var RadiusAxis\SplitLine 坐标轴在 grid 区域中的分隔线。
     */
    public $splitLine;        
        
    /**
     * @var RadiusAxis\SplitArea 坐标轴在 grid 区域中的分隔区域，默认不显示。
     */
    public $splitArea;        
    ...
    /**
     * @var RadiusAxis\AxisPointer axisPointer settings on axis.
     */
    public $axisPointer;        
        
    /**
     * @var int 半径轴所有图形的 zlevel 值。
    ...
    /**
     * @var int 半径轴组件的所有图形的z值。控制图形的前后顺序。z值小的图形会被z值大的图形覆盖。
