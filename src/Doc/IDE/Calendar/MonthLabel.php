...
{            
    ...
    /**
     * @var int 月份标签与轴线之间的距离
     */
    public $margin = 5;        
        
    /**
     * @var string 月份的位置 在开头还是结尾。
     * 可选：
     * 
     * start
     * end
    ...
    /**
     * @var string|array 月份显示的效果，默认为en
     * 可设置中英文以及自定义
     * 下标0为对应一月的文字显示
     * 使用示例：
     * // 快捷设置英文 [
    ...
    /**
     * @var string|callable 用来格式化月份文本，支持字符串模板和回调函数两种形式。
     * 示例：
     * // 使用字符串模板，例如：2017-02
     * 
    ...
    /**
     * @var MonthLabel\TextStyle 普通状态下的标签文本样式。
     */
    public $textStyle;
