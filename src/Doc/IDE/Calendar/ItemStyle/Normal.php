...
namespace Hisune\EchartsPHP\Doc\IDE\Calendar\ItemStyle;

class Normal
{            
        
    /**
     * @var string calendar color. 
     * 
    ...
    /**
     * @var string calendar border color, whose format is similar to that of color.
     */
    public $borderColor = '#ccc';        
        
    /**
     * @var int calendar border width. No border when it is set to be 0.
     */
