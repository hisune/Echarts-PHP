...
{            
    ...
    /**
     * @var string 进行力引导布局前的初始化布局，初始化布局会影响到力引导的效果。
    ...
    /**
     * @var array|int 节点之间的斥力因子。
     * 支持设置成数组表达斥力的范围，此时不同大小的值会线性映射到不同的斥力。值越大则斥力越大
     */
    public $repulsion = 50;        
        
    /**
     * @var int 节点受到的向中心的引力因子。该值越大节点越往中心点靠拢。
     */
    public $gravity = 0.1;        
        
    /**
     * @var array|int 边的两个节点之间的距离，这个距离也会受 repulsion。
    ...
    /**
     * @var boolean 因为力引导布局会在多次迭代后才会稳定，这个参数决定是否显示布局的迭代动画，在浏览器端节点数据较多（&gt;100）的时候不建议关闭，布局过程会造成浏览器假死。
     */
