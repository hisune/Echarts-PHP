...
{            
    ...
    /**
     * @var int|array 起点标记的大小，可以设置成诸如 10 这样单一的数字，也可以用数组分开表示宽和高，例如 [20, 10] 表示标记宽为20，高为10。
     */
    public $symbolSize;        
        
    /**
     * @var int 起点标记的旋转角度。注意在 markLine 中当 symbol 为 arrow 时会忽略 symbolRotate 强制设置为切线的角度。
     */
    public $symbolRotate;        
        
    /**
     * @var array 起点标记相对于原本位置的偏移。默认情况下，标记会居中置放在数据对应的位置，但是如果 symbol 是自定义的矢量路径或者图片，就有可能不希望 symbol 居中。这时候可以使用该配置项配置 symbol 相对于原本居中的偏移，可以是绝对的像素值，也可以是相对的百分比。
     * 例如 [0, 50%] 就是把自己向上移动了一半的位置，在 symbol 图形是气泡的时候可以让图形下端的箭头对准数据点。
     */
    public $symbolOffset = '[0, 0]';        
        
    /**
     * @var 0\LineStyle 该数据项线的样式，起点和终点项的 lineStyle会合并到一起。
     */
    public $lineStyle;        
        
    /**
     * @var 0\Label 该数据项标签的样式，起点和终点项的 label会合并到一起。
     */
    public $label;
