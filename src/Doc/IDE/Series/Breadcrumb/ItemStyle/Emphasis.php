...
{            
    ...
    /**
     * @var string boxplot图形的描边颜色。支持的格式同 color。
     */
    public $borderColor = 'rgba(255,255,255,0.7)';        
        
    /**
     * @var int boxplot描边线宽。为 0 时无描边。
     */
     ...
     */
    public $shadowColor = 'rgba(150,150,150,1)';        
