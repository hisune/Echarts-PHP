...
{            
    ...
    /**
     * @var int 特效动画的时间，单位为 s。
     */
    public $period = 4;        
        
    /**
     * @var int 配置特效图形的移动动画是否是固定速度，单位像素/秒，设置为大于 0 的值后会忽略 period 配置项。
     */
    ...
    /**
     * @var array|int 特效标记的大小，可以设置成诸如 10 这样单一的数字，也可以用数组分开表示高和宽，例如 [20, 10] 表示标记宽为20，高为10。
     */
    public $symbolSize = 3;        
        
    /**
     * @var string 特效标记的颜色，默认取 lineStyle.normal.color。
     */
    public $color;        
        
    /**
     * @var int 特效尾迹的长度。取从 0 到 1 的值，数值越大尾迹越长。
     */
    public $trailLength = 0.2;        
        
    /**
     * @var boolean 是否循环显示特效。
     */
    public $loop = true;
