...
{            
    ...
    /**
     * @var int Y 轴相对于默认位置的偏移，在相同的 position 上有多个 Y 轴的时候有用。
     */
    public $offset = 0;        
    ...
    /**
     * @var YAxis\NameTextStyle 坐标轴名称的文字样式。
     */
    ...
    /**
     * @var YAxis\AxisLine 坐标轴轴线相关设置。
     */
    public $axisLine;        
        
    /**
     * @var YAxis\AxisTick 坐标轴刻度相关设置。
     */
    public $axisTick;        
        
    /**
     * @var YAxis\AxisLabel 坐标轴刻度标签的相关设置。
     */
    public $axisLabel;        
        
    /**
     * @var YAxis\SplitLine 坐标轴在 grid 区域中的分隔线。
     */
    public $splitLine;        
        
    /**
     * @var YAxis\SplitArea 坐标轴在 grid 区域中的分隔区域，默认不显示。
     */
    public $splitArea;        
    ...
    /**
     * @var int Y 轴组件的所有图形的z值。控制图形的前后顺序。z值小的图形会被z值大的图形覆盖。
