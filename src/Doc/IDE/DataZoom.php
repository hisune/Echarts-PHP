...
{            
    ...
    /**
     * @var boolean 是否停止组件的功能。
     */
    public $disabled = false;        
        
    /**
     * @var int|array 设置 dataZoom-inside 组件控制的 x轴（即xAxis，是直角坐标系中的概念，参见 grid）。
    ...
    /**
     * @var int|array 设置 dataZoom-inside 组件控制的 y轴（即yAxis，是直角坐标系中的概念，参见 grid）。
    ...
    /**
     * @var int|array 设置 dataZoom-inside 组件控制的 radius 轴（即radiusAxis，是直角坐标系中的概念，参见 polar）。
     * 如果是 number 表示控制一个轴，如果是 Array 表示控制多个轴。
     * 例如有如下 ECharts option：
     * option: {
     *     radiusAxis: [
    ...
    /**
     * @var int|array 设置 dataZoom-inside 组件控制的 angle 轴（即angleAxis，是直角坐标系中的概念，参见 polar）。
     * 如果是 number 表示控制一个轴，如果是 Array 表示控制多个轴。
     * 例如有如下 ECharts option：
     * option: {
     *     angleAxis: [
    ...
    /**
     * @var string dataZoom 的运行原理是通过 数据过滤 来达到 数据窗口缩放 的效果。数据过滤模式的设置不同，效果也不同。
     * 可选值为：
     * 
    ...
    /**
     * @var int 数据窗口范围的起始百分比。范围是：0 ~ 100。表示 0% ~ 100%。
     * dataZoom-inside.start 和 dataZoom-inside.end 共同用 百分比 的形式定义了数据窗口范围。
     */
    public $start = 0;        
        
    /**
     * @var int 数据窗口范围的结束百分比。范围是：0 ~ 100。
     * dataZoom-inside.start 和 dataZoom-inside.end 共同用 百分比 的形式定义了数据窗口范围。
     */
    public $end = 100;        
        
    /**
     * @var int|string|Date 数据窗口范围的起始数值。如果设置了 dataZoom-inside.start 则 startValue 失效。
    ...
    /**
     * @var int|string|Date 数据窗口范围的结束数值。如果设置了 dataZoom-inside.end 则 endValue 失效。
     * dataZoom-inside.startValue 和 dataZoom-inside.endValue 共同用 绝对数值 的形式定义了数据窗口范围。
    ...
    /**
     * @var string 布局方式是横还是竖。不仅是布局方式，对于直角坐标系而言，也决定了，缺省情况控制横向数轴还是纵向数轴。
     * 可选值为：
     * 
     * horizontal：水平。
     * 
    ...
    /**
     * @var boolean 是否锁定选择区域（或叫做数据窗口）的大小。
     * 如果设置为 true 则锁定选择区域的大小，也就是说，只能平移，不能缩放。
     */
    public $zoomLock = false;        
        
    /**
     * @var int 设置触发视图刷新的频率。单位为毫秒（ms）。
    ...
    /**
     * @var boolean 是否显示  组件。如果设置为 false，不会显示，但是数据过滤的功能还存在。
     */
    public $show = true;        
    ...
    /**
     * @var DataZoom\DataBackground 数据阴影的样式。
     */
    public $dataBackground;        
        
    /**
     * @var string 选中范围的填充颜色。
     */
    ...
    /**
     * @var string 手柄的 icon 形状，支持路径字符串，默认为：
    ...
    /**
     * @var int 控制手柄的尺寸，可以是像素大小，也可以是相对于 dataZoom 组件宽度的百分比，默认跟 dataZoom 宽度相同。
     */
    public $handleSize = '100%';        
        
    /**
     * @var DataZoom\HandleStyle 手柄的样式配置，见 示例 area-simple
     */
    public $handleStyle;        
        
    /**
     * @var int 显示label的小数精度。默认根据数据自动决定。
     */
    public $labelPrecision = 'auto';        
        
    /**
     * @var string|callable 显示的label的格式化器。
     * 
    ...
    /**
     * @var boolean 是否显示detail，即拖拽时候显示详细数值信息。
     */
    public $showDetail = true;        
        
    /**
     * @var string 是否在 dataZoom-silder 组件中显示数据阴影。数据阴影可以简单地反应数据走势。
     */
    public $showDataShadow = 'auto';        
        
    /**
     * @var boolean 拖动时，是否实时更新系列的视图。如果设置为 false，则只在拖拽结束的时候更新。
     */
    public $realtime = true;        
        
    /**
     * @var DataZoom\TextStyle 
     */
    public $textStyle;        
    ...
    /**
     * @var string|int dataZoom-slider组件离容器左侧的距离。
    ...
    /**
     * @var string|int dataZoom-slider组件离容器上侧的距离。
    ...
    /**
     * @var string|int dataZoom-slider组件离容器右侧的距离。
    ...
    /**
     * @var string|int dataZoom-slider组件离容器下侧的距离。
